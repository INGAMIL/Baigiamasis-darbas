...
# prie nauju populiauriusiu markiu 2021 pridejome stulpeli su visais pirkimais pamenesiui is automobiliu registracijos 2021


# populiariausios_naujos_markes_2021_new = pd.read_csv('populiariausios_naujos_markes_2021.csv')
# automobiliu_registracija_2021 = pd.read_csv('automobiliu_registracija_2021.csv')
...
# populiariausios_naujos_markes_2021_new.to_csv('populiariausios_naujos_markes_2021_new.csv', index=False)

# prie nauju populiauriusiu markiu 2022 pridejome stulpeli su visais pirkimais pamenesiui is automobiliu registracijos 2021


# populiariausios_naujos_markes_2022_new = pd.read_csv('populiariausios_naujos_markes_2022.csv')
# automobiliu_registracija_2022 = pd.read_csv('automobiliu_registracija_2022.csv')
...
# populiariausios_naujos_markes_2022_new.to_csv('populiariausios_naujos_markes_2022_new.csv', index=False)




# Procentinė populiariausiu M1 klases nauju automobiliu dalis nuo visu nauju registruotu 2021

# df = pd.read_csv('populiariausios_naujos_markes_2021_new.csv', skipfooter=1, engine='python')
...
# #
# df = pd.read_csv('populiariausios_naujos_markes_2022_new.csv',skipfooter=1, engine='python')
# df = df[df['Unnamed: 0'] != 'Iš viso']
#
