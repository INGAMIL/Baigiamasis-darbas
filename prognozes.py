...
plt.legend()
plt.grid(True)
plt.savefig('Grafikai/Nauju_automobiliu_ivezimo_prognoze.jpg')
plt.show()
...
plt.xlabel('Metai')
plt.ylabel('Automobilių skaičius')
plt.title('Elektromobilių įvežimo prognozė')
plt.legend()
plt.grid(True)
plt.savefig('Grafikai/Elektromobiliu_ivezimo_prognoze.jpg')
plt.show()
...
plt.xlabel('Metai')
plt.ylabel('Automobilių skaičius')
plt.title('Hibridų(benzinas/elektra) įvežimo prognozė')
plt.legend()
plt.grid(True)
plt.savefig('Grafikai/Hibridu_ivezimo_prognoze.jpg')
plt.show()
